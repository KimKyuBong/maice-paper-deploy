...
| 영역 | 항목 | 배점 | 평가 내용 |
|------|------|:----:|----------|
| **A. 질문** (15점) | A1. 수학적 전문성 | 5점 | 수학 개념 정확성, 용어 사용 적절성 |
| | A2. 질문 구조화 | 5점 | 질문 단일성, 조건 완결성, 의도 명확성 |
| | A3. 학습 맥락 | 5점 | 학습 단계, 선수학습, 어려움, 목표 명시 |
| **B. 답변** (15점) | B1. 학습자 맞춤 | 5점 | 수준별 접근, 선수지식 연계, 난이도 조절 |
| | B2. 설명 체계성 | 5점 | 개념 위계화, 논리 전개, 핵심 강조 |
| | B3. 학습 확장성 | 5점 | 심화 방향, 응용 연계, 자기주도 유도 |
| **C. 맥락** (10점) | C1. 대화 일관성 | 5점 | 목표 중심성, 맥락 참조, 주제 연속성 |
| | C2. 학습 지원 | 5점 | 사고 과정 유도, 이해도 확인, 메타인지 촉진 |
...
| 지표 | 값 | 기준 | 해석 |
|------|:-:|:----:|------|
| **평가자 간 신뢰도** (AI 3개 모델, n=221) | | | |
| ICC(2,1) | 0.595 | >0.60 양호 | 보통 수준 |
| Cronbach's α | 0.840 | >0.80 좋음 | 높은 내적 일관성 |
| 평균 Pearson r | 0.649 | >0.60 강함 | 중간~강한 상관 |
| **교사 간 신뢰도** (교사 2명, n=100) | | | |
| Pearson r | 0.644 | >0.60 강함 | 중간~강한 상관 |
| **AI-교사 일치도** (Claude-4.5-Haiku, n=97) | | | |
| Pearson r | 0.771 | >0.70 매우 높음 | 매우 높은 일치도 |
