...
**루브릭의 독창적 기여**: 본 루브릭은 기존 AI 교육 평가 연구(MRBench, Degen의 소크라테스 튜터 연구)가 주로 AI 응답 품질에 초점을 맞춘 것과 달리, (1) 학생 질문의 품질을 독립적으로 평가하고, (2) 실제 교실 데이터 분석을 통해 관찰된 문제를 직접 해결하며, (3) 전통적 교육학 이론과 최신 AI 평가 연구를 통합하고, (4) 질문 품질과 답변 품질 간 강한 상관관계(r=0.691)를 실증하여 질문 명료화가 학습 효과 향상의 핵심 메커니즘임을 입증하였다.
