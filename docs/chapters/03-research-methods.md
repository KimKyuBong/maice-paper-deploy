...
본 연구는 예비조사(N=385, 2025년 5월)를 통해 AI 에이전트 시스템 설계 필요성을 확인하였다 (상세: III장 1절).
...
학생들은 수업 시간과 쉬는 시간을 활용하여 AI 학습 시스템을 자유롭게 사용하였다:
...
**통제 불가 변인**: AI 시스템 활용 시간, 세션 횟수, 학습 습관, 가정 학습 (무작위 배정으로 균등 분산)
